package test.day17_CucumberRecap;

public class day17_SeleniumNotes {
...
-->RECAP
	...
	3- Hybrid framework:
		-> Hybrid framework is when we implement the logic of different type of frameworks such as TDD, BDD,
		Data driven etc we call that framework: HYBRID FRAMEWORK.
...
-> How to convert normal java class to cucumber runner class?
	...
	#2--> We are passing additional required options to allow our runner class to know where the
	 feature files and where the step definitions are.
...
RERUN : IS BUILT IN PLUGIN IN CUCUMBER
	...
	-> Which will cause your tests to fail, therefore cucumber rerun plugin will save the failed
	tests in to the rerun.txt file.
